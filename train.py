...
parser.add_argument('--token_name_or_path', type=str, default='microsoft/codebert-base')

parser.add_argument('--train_mark_path', type=str, default='./data/train_mark.csv')
parser.add_argument('--train_features_path', type=str, default='./data/train_fts_clean.json')
parser.add_argument('--val_mark_path', type=str, default='./data/val_mark.csv')
parser.add_argument('--val_features_path', type=str, default='./data/val_fts_clean.json')
...
train_ds = MarkdownDataset(train_df_mark, model_name_or_path=args.token_name_or_path, md_max_len=args.md_max_len,
                           total_max_len=args.total_max_len, fts=train_fts)
val_ds = MarkdownDataset(val_df_mark, model_name_or_path=args.token_name_or_path, md_max_len=args.md_max_len,
...
def train(model, train_loader, val_loader, epochs):
    ...
    for e in range(epochs):
        ...
        torch.save(model.state_dict(), "./outputs/codebert-base-{}-{}-clean-MarkdownDatasetVal.bin".format(e, score))
